...
export const BtnAdd = (onClick: ()=>void) =>{
    return(
...
export const BtnAEdit = ({onClick}: any) =>{
    return(
        <button onClick={onClick} type="button" className="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg px-3 py-2 text-xs me-2 mb-2 dark:focus:ring-yellow-900">Yellow</button>
    )
}
export const BtnDelete = ({onClick}: any) =>{
    return(
            <button onClick={onClick} type="button" className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg px-3 py-2 text-xs me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Red</button>
        )
}